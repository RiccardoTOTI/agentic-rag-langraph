...
ADD . /deps/retrieval-agent-template
# -- End of local package . --

# -- Installing all local dependencies --
RUN PYTHONDONTWRITEBYTECODE=1 pip install --no-cache-dir -c /api/constraints.txt -e /deps/*
# -- End of local dependencies install --
ENV LANGSERVE_GRAPHS='{"retrieval_graph": "/deps/retrieval-agent-template/src/retrieval_graph/graph.py:graph"}'
...
WORKDIR /deps/retrieval-agent-template